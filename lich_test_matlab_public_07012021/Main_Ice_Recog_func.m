...
%%
struct_type = {'Total'; 'C'; 'H'; 'CH'; 'CI'; 'HI'; 'MI'; 'I'; 'L'};
struct_number = [watoms_num; sum(Labels==1); sum(Labels==2); sum(Labels==6); sum(Labels==4); sum(Labels==5); sum(Labels==3); sum(Labels==7); sum(Labels==0)];
